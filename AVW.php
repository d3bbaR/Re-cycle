...
<head>
    ...
    <title>Algemene verkoopswaarden</title>
</head>
<body>
    <?php include 'nav-bar.php'; ?>
    <div class="AVW">
        <h2>ALGEMENE VERKOOPSWAARDEN</h2>
