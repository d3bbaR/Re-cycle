...
foreach (query($select) as $res) {
    ...
    header("Location:../R/afspraken.php?nomail=1");
...
//require 'vendor/autoload.php';
    ...
    try {
        ...
        $mail->Body = "de afspraak die je hebt aangevraagd voor" . " " . $datum . " om" . $uur . " is afgewezen gelieve op een ander moment een afspraak te maken";
